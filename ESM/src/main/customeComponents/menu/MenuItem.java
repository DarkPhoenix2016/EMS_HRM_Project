...
import main.customeComponents.effect.RippleEffect;
import main.customeComponents.effect.shadow.ShadowRenderer;
...
public class MenuItem extends JButton {
    ...
    public MenuItem(String name, int index, boolean subMenuAble) {
        ...
        rippleEffect.setRippleColor(new Color(0,180,252));
    }
    ...
    private void createShadowImage() {
        ...
        shadow = new ShadowRenderer(shadowSize, 0.2f, new Color(255, 255, 255)).createShadow(img);
        g2.dispose();
    }
    ...
    public void initSubMenu(int subMenuIndex, int length) {
        ...
        setBackground(new Color(1,38,119));
        setOpaque(true);
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (length != 0) {
            g2.setColor(new Color(0,180,252));
            if (subMenuIndex == 1) {
                //  First Index
