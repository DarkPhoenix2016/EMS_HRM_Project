...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2024 at 05:11 PM
...
INSERT INTO `00_admins` (`ID`, `Username`, `Password`) VALUES
(1, 'Admin', '$2a$09$OHolzl3mVm3ZiJ9GFX3Kzu7HsNUe5MXaOerUuZdYpn/dlYikNNpgK');
...
INSERT INTO `01_02_employee_designation` (`EmpNumber`, `DesignationID`, `AppointedDate`, `DesignatedStep`, `SalaryDate`, `AnualLeaves`) VALUES
('DBSEMP_1', 2, '2023-06-21', 1, 0, 0),
('DBSEMP_1', 3, '2023-06-22', 2, 0, 0),
('DBSEMP_1', 1, '2023-06-25', 3, 0, 0),
('DBSEMP_1', 4, '2023-06-25', 4, 0, 0),
('DBSEMP_2', 1, '2023-06-21', 1, 0, 0),
('DBSEMP_2', 5, '2023-06-25', 2, 0, 0),
('DBSEMP_2', 2, '2023-07-20', 3, 0, 0);
...
INSERT INTO `01_03_employee_salary` (`EmpNumber`, `BasicSalary`, `OTRate`) VALUES
('DBSEMP_1', 0.00, 100.00),
('DBSEMP_2', 0.00, 100.00);
...
INSERT INTO `01_07_employee_accounts` (`EmpNumber`, `Role`, `Username`, `Password`) VALUES
('DBSEMP_1', 'Admin', 'DBSEMP_1', '$2a$09$skML0p3LtRQMANVp0UM/kuC7f.KXFDKZqOc4SBb1znj7loMcME32e'),
('DBSEMP_2', 'Employee', 'DBSEMP_2', '$2a$09$58ZJQSTBqaVcNNUIehvLfu8.otNfck3O34a9LJJAJcNRKZAyfHfkC');
...
--
-- Indexes for table `00_admins`
--
ALTER TABLE `00_admins`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `01_01_employee_education`
--
ALTER TABLE `01_01_employee_education`
  ADD PRIMARY KEY (`EmpNumber`);

--
-- Indexes for table `01_02_employee_designation`
--
ALTER TABLE `01_02_employee_designation`
  ADD PRIMARY KEY (`EmpNumber`,`DesignatedStep`);

--
-- Indexes for table `01_04_employee_attendence`
--
ALTER TABLE `01_04_employee_attendence`
  ADD PRIMARY KEY (`EmpNumber`,`Date`);

--
-- Indexes for table `01_07_employee_accounts`
--
ALTER TABLE `01_07_employee_accounts`
  ADD PRIMARY KEY (`EmpNumber`);
...
--
-- AUTO_INCREMENT for table `00_admins`
--
ALTER TABLE `00_admins`
